...
static unsigned aux_pcm_gpio_off[] = {
	GPIO_CFG(FLYER_GPIO_BT_PCM_OUT, 0, GPIO_CFG_OUTPUT,
			GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_GPIO_BT_PCM_IN, 0, GPIO_CFG_INPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_GPIO_BT_PCM_SYNC, 0, GPIO_CFG_INPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_GPIO_BT_PCM_CLK, 0, GPIO_CFG_INPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};

static unsigned aux_pcm_gpio_on[] = {
	GPIO_CFG(FLYER_GPIO_BT_PCM_OUT, 1, GPIO_CFG_OUTPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_GPIO_BT_PCM_IN, 1, GPIO_CFG_INPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_GPIO_BT_PCM_SYNC, 1, GPIO_CFG_OUTPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_GPIO_BT_PCM_CLK, 1, GPIO_CFG_OUTPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};

static unsigned mi2s_clk_gpios_on[] = {
	GPIO_CFG(FLYER_WCF_I2S_CLK_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_WCF_I2S_WS_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_WCA_MCLK_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};

static unsigned mi2s_clk_gpios_off[] = {
	GPIO_CFG(FLYER_WCF_I2S_CLK_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_WCF_I2S_WS_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_WCA_MCLK_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
};

static unsigned mi2s_rx_data_lines_gpios_on[] = {
	GPIO_CFG(FLYER_WCA_DATA_SD0_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_WCA_DATA_SD1_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_WCA_DATA_SD2_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_WCF_I2S_DATA_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};

static unsigned mi2s_rx_data_lines_gpios_off[] = {
	GPIO_CFG(FLYER_WCA_DATA_SD0_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_WCA_DATA_SD1_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_WCA_DATA_SD2_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(FLYER_WCF_I2S_DATA_XC, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
};
...
void __init flyer_audio_init(void)
{
	...
	pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(FLYER_AUD_SPKR_EN), &audio_pwr);
	pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(FLYER_AUD_HP_EN), &audio_pwr);
	if (board_ver >= 30 && board_ver < 43)
		pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(FLYER_AUD_MICPATH_SEL_XC), &audio_pwr);
	/* Rest AIC3254 */
	gpio_set_value(FLYER_AUD_CODEC_RST, 0);
	mdelay(1);
	gpio_set_value(FLYER_AUD_CODEC_RST, 1);
	audio_pwr.vin_sel = 2;
	pm8xxx_gpio_config(PM8058_GPIO_PM_TO_SYS(FLYER_AUD_LO_EN_XD), &audio_pwr);
	mutex_lock(&bt_sco_lock);
