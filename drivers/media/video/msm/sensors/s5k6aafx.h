...
#if defined(CONFIG_MACH_FLYER) || defined(CONFIG_MACH_SHOOTER) || defined(CONFIG_MACH_SHOOTER_K) || defined(CONFIG_MACH_SHOOTER_U) || defined(CONFIG_MACH_RIDER)  || defined(CONFIG_MACH_VILLEC2) || defined(CONFIG_MACH_HOLIDAY) || defined(CONFIG_MACH_VERDI_LTE) || defined(CONFIG_MACH_KINGDOM) || defined(CONFIG_MACH_SHOOTER_CT)
